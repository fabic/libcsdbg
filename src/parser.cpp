...
/**
	...
	@brief Class csdbg::parser method implementation
*/
...
parser *parser::m_default = NULL;

style *parser::m_fallback = NULL;
...
/**
 * @brief Stream insertion operator for csdbg::parser objects
 *
 ...
 * @throws std::bad_alloc
 */
chain<string>* parser::get_dictionary_names() const
{
 ...
 * @param[in] nm the style name
 *
 * @returns the style or parser::m_fallback if no such style is registered
 */
 ...
 * @throws std::bad_alloc
 */
chain<string>* parser::get_style_names() const
{
	chain<string> *retval = new chain<string>;
	string *nm = NULL;
...
{
	dictionary *dict = get_dictionary(nm);
